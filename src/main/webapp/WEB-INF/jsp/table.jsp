...
<body>
	...
	<div class="col-sm-8 mt-4 ml-auto mr-auto">
		<h3 class="text-center mb-4">${table.header}</h3>
		<c:url var="createLink"
			value="${pageContext.request.contextPath}/api/subject-form-create">
			<c:param name="tableId" value="${table.id}"></c:param>
		</c:url>
		<button class="btn btn-outline-secondary btn-block mt-4"
			onclick="window.location.href='${createLink}'">Create
			Subject</button>
		<table class="table mb-5">
			<thead class="thead-dark">
				<tr>
					<th><a href="${pageContext.request.contextPath}/api/table/${table.id}/sortHeader">Header</a></th>
					<th>Link</th>
					<th>Note</th>
					<th><a href="${pageContext.request.contextPath}/api/table/${table.id}/sortDate">Date</a></th>
